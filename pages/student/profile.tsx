...
const StudentProfile: React.FC<{ student: any }> = ({ student }) => {
  ...
  const [otherInfoOpen, setOtherInfo] = useState(false);
        ...
        <div className={styles.profilePage}>
          ...
          {studentAnalytics ? (
            <div className={styles.bgOther}>
              ...
              >
                <Button variant="outlined" color="primary" className={styles.buttonGroup}>
                  New Session
                </Button>
              </Link>
            </div>
          ...
          <p className={styles.info}> {formatDate(new Date(student.dob))}</p>
          <p className={styles.label}>Parent's Phone Number:</p>
          <p className={styles.info}>
            {`(${student.parentPhone.slice(0, 3)}) ${student.parentPhone.slice(3, 6)}-${student.parentPhone.slice(6, 10)}`}
          </p>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                When archiving a student, you will no longer be able to view any of the records of the student.
                To regain access, you will have to get access from an administrator.
              </DialogContentText>
            </DialogContent>
            <DialogActions>
              ...
              <Button onClick={handleArchive} color="primary" autoFocus className={styles.buttonGroup}>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">{student.otherInfo}</DialogContentText>
            </DialogContent>
            <DialogActions>
